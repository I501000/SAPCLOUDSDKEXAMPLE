...
export const StoreFormTemplatesApi = {
   ...
   */
  templatesGet: (formName: string, queryParameters?: {'locale'?: string,
  'language'?: string,
  'templateName'?: string,
  ...
  'limit'?: number,
  'offset'?: number,
  'select'?: string[]}) => new OpenApiRequestBuilder<TemplateStoreOutput[]>(
    'get',
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  templatePost: (formName: string, body: TemplateStoreInput) => new OpenApiRequestBuilder<TemplateMetadata>(
    'post',
    '/v1/forms/{formName}/templates',
    {
          pathParameters: { formName },
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  templateGet: (formName: string, templateName: string, queryParameters?: {'select'?: string[],
  'isObjectId'?: boolean}) => new OpenApiRequestBuilder<TemplateStoreOutput>(
    'get',
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  templatePut: (formName: string, templateName: string, body: TemplateUpdateStoreInput, queryParameters?: {'isObjectId'?: boolean}) => new OpenApiRequestBuilder<TemplateMetadata>(
    'put',
    '/v1/forms/{formName}/templates/{templateName}',
    {
          pathParameters: { formName, templateName },
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  templateDelete: (formName: string, templateName: string, queryParameters?: {'allVersions'?: boolean,
  'isObjectId'?: boolean}) => new OpenApiRequestBuilder<string>(
    'delete',
    '/v1/forms/{formName}/templates/{templateName}',
    {
          pathParameters: { formName, templateName },
