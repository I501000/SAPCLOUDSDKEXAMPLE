...
export const StoreFormSchemaApi = {
   ...
   */
  schemaPost: (formName: string, body: SchemaStoreInput) => new OpenApiRequestBuilder<SchemaMetadata>(
    'post',
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  schemaGet: (formName: string, schemaName: string, queryParameters?: {'select'?: string[],
  'isObjectId'?: boolean}) => new OpenApiRequestBuilder<SchemaStoreOutput>(
    'get',
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  schemaPut: (formName: string, schemaName: string, body: SchemaUpdateStoreInput, queryParameters?: {'isObjectId'?: boolean}) => new OpenApiRequestBuilder<SchemaMetadata>(
    'put',
    '/v1/forms/{formName}/schema/{schemaName}',
    {
          pathParameters: { formName, schemaName },
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  schemaDelete: (formName: string, schemaName: string, queryParameters?: {'allVersions'?: boolean,
