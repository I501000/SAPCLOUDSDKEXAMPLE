...
export const ADSGetRequestsApi = {
   ...
   */
  pDfGetAttachmentsPost: (body: PDFInput, queryParameters?: {'TraceLevel'?: number}) => new OpenApiRequestBuilder<AttachmentsOutput>(
    'post',
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  pDfListAttachmentsPost: (body: PDFInput, queryParameters?: {'TraceLevel'?: number}) => new OpenApiRequestBuilder<AttachmentsListOutput>(
    'post',
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  pDfGetDataPost: (body: PDFInput, queryParameters?: {'TraceLevel'?: number}) => new OpenApiRequestBuilder<FileOutput>(
    'post',
    '/v1/pdf/adsGet/data',
    {
          body,
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  pDfGetSignaturePost: (body: PDFInput, queryParameters?: {'TraceLevel'?: number}) => new OpenApiRequestBuilder<SignaturesOutput>(
    'post',
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  templateGetSchema: (body: TemplateInput, queryParameters?: {'TraceLevel'?: number}) => new OpenApiRequestBuilder<FileOutput>(
    'post',
