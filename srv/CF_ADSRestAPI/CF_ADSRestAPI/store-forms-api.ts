...
export const StoreFormsApi = {
   ...
   */
  formsGet: (queryParameters?: {'limit'?: number,
  'offset'?: number,
  'select'?: string[]}) => new OpenApiRequestBuilder<FormStoreOutput[]>(
    'get',
    '/v1/forms',
    {
          queryParameters
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  formPost: (body: FormStoreInput) => new OpenApiRequestBuilder<FormMetadata>(
    'post',
    '/v1/forms',
    {
          body
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  formGet: (formName: string, queryParameters?: {'select'?: string[]}) => new OpenApiRequestBuilder<FormStoreOutput>(
    'get',
    '/v1/forms/{formName}',
    {
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  formPut: (formName: string, body: FormStoreInput) => new OpenApiRequestBuilder<FormMetadata>(
    'put',
    '/v1/forms/{formName}',
    {
          pathParameters: { formName },
   ...
   * @returns The request builder, use the `execute()` method to trigger the request.
   */
  formDelete: (formName: string) => new OpenApiRequestBuilder<string>(
    'delete',
    '/v1/forms/{formName}',
    {
          pathParameters: { formName }
